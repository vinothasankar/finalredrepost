...
if web=="Project Info":
     ...
     if slt.button(":blue[ S E L E N  I U M ]"):
          slt.markdown(" # :red[SELENIUM]: Tool to Automate Web Browser and Web Scrapping")
     if slt.button(":blue[P A N D A]"):
          slt.markdown(" # :red[PANDA]: Data manipulation , Cleaning and Preprocessing")
     if slt.button(":blue[ M Y S Q L ]"):
          slt.markdown(" # :red[MYSQL]: To establish connection to SQL database]")
     if slt.button(":blue[S T R E A M L I T]"):
          slt.markdown(" # :red[STREAMLIT]: Develop Interactive Application")
